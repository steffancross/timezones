...
export interface WorkingHours {
  /** Start hour, 0-23. Inclusive (clock-in). */
  readonly start: number;
  /**
   * End hour, 0-23. Exclusive — the clock-out time, NOT a worked hour. So 9-17
   * means the 9am through 4pm hour columns are working (an 8-hour 9-to-5 day);
   * the 5pm column is quitting time and is not shaded.
   */
  readonly end: number;
